...
This repository contains practical implementations, source code, and comprehensive lab reports for DevOps course assignments.

---

## Folder Structure & Assignment Status

| Directory | Title | Status | Technology Stack |
| :--- | :--- | :--- | :--- |
...
### [Assignment 1: Git Repository and Branch Management](./Assignment%201/)
...
- **Core Topics:** Continuous Integration, GitHub Actions, Workflows, Jobs, Steps, Runners, Actions, Automated Linting and Testing
